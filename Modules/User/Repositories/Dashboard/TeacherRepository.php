...
class TeacherRepository
{
    ...
    {
        $users = $this->user->teacherUser()->count();
    ...
    */
    ...
    {
        $users = $this->user->teacherUser()->orderBy($order, $sort)->get();
        return $users;
    }
    ...
    */
    ...
    {
        $users = $this->user->teacherUser()->active()->orderBy($order, $sort)->select("id", "name")->get();
        return $users;
    }
    ...
    */
    ...
    {
        $query = $this->user->withDeleted()->where('id', '!=', auth()->id())->teacherUser()->where(function ($query) use ($request) {
