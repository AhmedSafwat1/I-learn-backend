                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                ...
                                                                <th>{{__('user::dashboard.users.datatable.verifed')}}</th>
                                                            </label>
                                                          
                                                                <select class="form-control" name="is_verified">
                                                                  <option value="">{{__('apps::dashboard.datatable.all')}}</option>
                                                                  <option value="1">{{__('user::dashboard.users.datatable.is_verifed')}}</option>
                                                                  <option value="0">{{__('user::dashboard.users.datatable.not_verifed')}}</option>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{__('user::dashboard.users.datatable.gender')}}</th>
      ...
      $('#dataTable').DataTable({
          ...
          columns: [
            ...
            {data: 'email' 	          , className: 'dt-center'},
                  ...
                  var msg = data == 1  ? "{{__('user::dashboard.users.datatable.is_verifed')}}"
                              : "{{__('user::dashboard.users.datatable.not_verifed')}}" ;
