                                                ...
                                                <ul>
                                                    ...
                                                    <li style="list-style-type:none">
                                                        ...
                                                        <ul style="list-style-type:none">
                                                            ...
                                                            <li style="list-style-type:none">
                                                                <label class="mt-checkbox">
                                                                    <input class="child" type="checkbox" name="permission[]" value="{{$permission->id}}" {{ $role->permissions->contains($permission->id) ? 'checked=""' : ''}}>
                                                                    {{$permission->translateOrDefault(locale())->description}}
                                                                    <span></span>
                                                                </label>
                                                            </li>
                                                            @endforeach
