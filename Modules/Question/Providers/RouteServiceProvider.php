...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapDashboardRoutes()
    {
        ...
        ->namespace($this->dashboardModule)->group(function() {
            ...
            foreach (File::allFiles(module_path('Question', 'Routes/dashboard')) as $file) {
    ...
    protected function mapWebRoutes()
    {
        ...
        ->namespace($this->frontendModule)->group(function() {
            ...
            foreach (File::allFiles(module_path('Question', 'Routes/frontend')) as $file) {
                require_once($file->getPathname());
            }
    ...
    protected function mapApiRoutes()
    {
        Route::group(['prefix'=>'api' ,'middleware' => ['api'] , 'namespace' => $this->apiModule],function() {
            ...
            foreach (File::allFiles(module_path('Question', 'Routes/api')) as $file) {
                require_once($file->getPathname());
            }
